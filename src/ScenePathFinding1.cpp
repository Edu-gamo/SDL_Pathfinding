...
ScenePathFinding1::ScenePathFinding1()
{
	draw_grid = false;
...
void ScenePathFinding1::update(float dtime, SDL_Event *event)
{
...
const char* ScenePathFinding1::getTitle()
{
	return "SDL Steering Behaviors :: PathFinding1 Demo";
}

void ScenePathFinding1::drawMaze()
{
	if (draw_grid)
	{
...
void ScenePathFinding1::drawCoin()
{
...
void ScenePathFinding1::initMaze()
{
...
bool ScenePathFinding1::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D ScenePathFinding1::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D ScenePathFinding1::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x / CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool ScenePathFinding1::isValidCell(Vector2D cell)
{
